...
ignore = [".git", "Figures", "data", ".pdf", ".svg", ".mat", "build", "managed_components", ".log", "Generated_Source", "Export", "CortexM3", "codegentemp", ".eps", ".wav", ".txt", ".yml", ".old", ".vscode", ".tardi", ".pem", ".key", ".pac", ".crt", ".lock", ".jpg", ".jpeg", ".md"]
