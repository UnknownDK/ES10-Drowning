...
static __attribute__((aligned(16))) float mic_inputs[SAMPLES_PER_MIC*3];//NUMBER_OF_MICS*SAMPLES_PER_MIC];
...
void app_main(void)
{
    ...
    xTaskCreatePinnedToCore(&spi_slave_task, "spi_slave_task", 2048, NULL, 5, &spi_task_handle, 0);
    ...
    while (1) {
        ...
        */
        ...
        //for (int i = 0; i < 3584 - 1; i +=2){
        for (int i = 0; i < 512*3 - 1; i +=2){
